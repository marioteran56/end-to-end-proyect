...
with col1:
    ...
    housing_median_age = st.number_input('Edad media de la vivienda', value=28)
    total_rooms = st.number_input('Total de habitaciones', value=1000)
    total_bedrooms = st.number_input('Total de habitaciones', value=200)
with col2:
    population = st.number_input('Población', value=1000)
    households = st.number_input('Casas', value=200)
    median_income = st.number_input('Ingreso medio', value=3)
